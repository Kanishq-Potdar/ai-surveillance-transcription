...
def main():
    ...
    parser.add_argument("--filter", nargs="*", help="Filter object classes, e.g. --filter person car")
    parser.add_argument("--csv", action="store_true", help="Save transcript as CSV instead of TXT")
